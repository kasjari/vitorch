...
# The naming is kind of different because this file also has the Radial nn.Module object
class RadialDistribution(Distribution):
    """
    Radial distribution as described in 
    ...
    def __init__(self, loc, scale, validate_args=None):
        ...
        super(RadialDistribution, self).__init__(batch_shape, validate_args=validate_args)
